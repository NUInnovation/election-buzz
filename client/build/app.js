...
/***/ function(module, exports, __webpack_require__) {
	...
	var hBarChart = __webpack_require__(92);
	...
	ReactDom.render((
	    React.createElement(Router, {history: ReactRouter.hashHistory}, routes)
	...
	var BarChart=React.createClass({displayName: "BarChart",
	  ...
	  render:function(){
	      ...
	      var rectBackground=(data).map(function(d, i) {
	          ...
	          return (
	              React.createElement("rect", {fill: "#58657f", rx: "3", ry: "3", key: i, 
	      ...
	      var rectForeground=(data).map(function(d, i) {
	          ...
	          return (
	              React.createElement("rect", {fill: "#74d3eb", rx: "3", ry: "3", key: i, 
	      ...
	      return(
	          React.createElement("div", null, 
	              React.createElement("svg", {id: this.props.chartId, width: this.state.width, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HBar = React.createClass({displayName: "HBar",
	  getInitialState: function(){
	...
	window.HBar = React.createClass({displayName: "window.HBar",
	  getDefaultProps: function() {
	    return {
	      width: 800,
	      height: 400,
	  ...
	  render: function() {
	    ...
	    */
	    ...
	    return (
	      React.createElement("svg", {className: "HBar", width: this.props.width, height: this.props.height}, 
	        React.createElement("g", null, 
	          data.map((point, i) =>
	              React.createElement(Bar, {key: point.label + i, 
	        ...
	        React.createElement("line", {className: "axis", 
	  ...
	  drawText: function(i, point, type){
	    ...
	    if (this.props.textPosition === 'fitted'){
	      ...
	      return (
	        React.createElement("g", {key: point.label + i, className: className, style: style}, 
	          React.createElement("text", {className: "inside", 
	                y: y, 
	                x: x - margin, 
	                textAnchor: "end"}, 
	          ...
	          React.createElement("text", {className: "right", 
	                y: y, 
	                x: x + margin, 
	                textAnchor: "start"}, 
	      ...
	      return (
	        React.createElement("g", {key: point.label + i, className: className, style: style}, 
	          React.createElement("text", {className: "left", 
	                y: y, 
	                x: this.xBase - margin, 
	                textAnchor: "end"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(161);
