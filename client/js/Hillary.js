      ...
      clintonFollowers = clintonFollowers.filter(filterThemselves);
        ...
        clintonFollowers.forEach(function(element){
          ...
          $('#followerProfiles_Clinton').append(
            '<div class="col-sm-2 twitter_link light_bkgnd" ><a href="http://twitter.com/'+element.screen_name+'"><div><img class="img-circle" style="width:100%" src="'+element.picture_url+'"></div>@'+element.screen_name+'</a></div>'
          );
        });
    });
