...
for topic in ['Security','Education','Immigration',"Hillary",'Trump','Cruz','Bernie','Kasich','Women','Supreme Court','Healthcare','Tax']:
	print "TAKING TOPICS RELATED TO:"
	print topic 
	print '-----------'
	if topic in dictionary['Topics'].keys():
		words = [x.lower() for x in dictionary['Topics'][topic]]
		print words
	else:
		words = []
